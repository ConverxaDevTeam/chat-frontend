...
const Chat = memo(({ onClose, agentId }: ChatProps) => {
  ...
  return (
    <div className="grid grid-rows-[auto,1fr,auto] max-w-full w-full h-full border-[0.5px] border-app-superDark rounded-lg shadow-lg bg-[url('/mvp/background-chats.png')] bg-cover bg-center bg-no-repeat">
