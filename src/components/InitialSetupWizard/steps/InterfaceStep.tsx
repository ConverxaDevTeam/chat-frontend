...
const InterfaceStep: React.FC<StepComponentProps> = ({
  data,
  updateData,
}) => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Define cómo se verá el chat en tu sitio web
        </p>
      </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <input
                type="text"
                value={data.interface.primaryColor}
                onChange={(e) => updateData("interface", { primaryColor: e.target.value })}
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <input
                type="text"
                value={data.interface.backgroundColor}
                onChange={(e) => updateData("interface", { backgroundColor: e.target.value })}
                className="flex-1 px-3 py-2 border border-gray-300 rounded-md text-sm"
                placeholder="#FFFFFF"
              />
            </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <input
                type="text"
                value={data.interface.textColor}
                onChange={(e) => updateData("interface", { textColor: e.target.value })}
                className="flex-1 px-3 py-2 border border-gray-300 rounded-md text-sm"
                placeholder="#333333"
              />
            </div>
      ...
      <div>
        ...
        <div className="relative bg-gray-100 rounded-lg h-64 overflow-hidden">
          ...
          <div
            className={`absolute ${
              data.interface.position.includes("bottom") ? "bottom-4" : "top-4"
            } ${
          ...
          >
            <button
              className={`w-14 h-14 flex items-center justify-center shadow-lg transition-transform hover:scale-110 ${
                data.interface.buttonStyle === "rounded" ? "rounded-full" : "rounded-lg"
              }`}
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { primary: "#10B981", bg: "#FFFFFF", text: "#1F2937", name: "Verde moderno" },
            { primary: "#3B82F6", bg: "#FFFFFF", text: "#1E293B", name: "Azul profesional" },
            { primary: "#8B5CF6", bg: "#FFFFFF", text: "#1F2937", name: "Púrpura creativo" },
            { primary: "#F59E0B", bg: "#FFFFFF", text: "#1F2937", name: "Naranja energético" },
            { primary: "#EF4444", bg: "#FFFFFF", text: "#1F2937", name: "Rojo dinámico" },
            { primary: "#1F2937", bg: "#FFFFFF", text: "#1F2937", name: "Negro elegante" },
          ].map((theme) => (
            <button
              key={theme.name}
              type="button"
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              Los colores deben contrastar bien entre sí para garantizar una buena
              legibilidad. El botón del chat debe ser fácilmente visible en tu sitio.
            </p>
          </div>
        </div>
      </div>
