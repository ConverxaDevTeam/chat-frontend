    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Tu asistente virtual está listo para comenzar a trabajar
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center py-2 border-b border-gray-200">
            <span className="text-sm text-gray-600">Base de conocimiento:</span>
            <span className="text-sm font-medium text-gray-900">
      ...
      <div className="bg-blue-50 rounded-lg p-6">
        ...
        <ul className="space-y-2">
          ...
          <li className="flex items-start">
            <span className="text-blue-600 mr-2">•</span>
            <span className="text-sm text-gray-700">
              Agrega más información a la base de conocimiento para mejorar las
              respuestas
            </span>
          </li>
          <li className="flex items-start">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="border border-gray-200 rounded-lg p-4 hover:border-sofia-electricGreen transition-colors cursor-pointer">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h5 className="font-medium text-gray-900">Base de conocimiento</h5>
          </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-green-700">
              Tu organización ha sido creada exitosamente. Ahora puedes acceder
              al panel de administración para gestionar todos los aspectos de tu
              asistente.
            </p>
          </div>
        </div>
