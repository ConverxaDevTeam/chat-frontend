...
const Interface = () => {
  ...
  return (
    <div className={`flex w-full min-h-full bg-web-color1 overflow-y-auto`}>
      <Sidebar
      ...
      <div className={`flex flex-1 flex-col p-[20px]`}>
        <div className="w-full h-[56px]">
          <div
            ...
            className={`${fixed ? "fixed" : ""} flex justify-between items-center h-[56px] px-[10px] bg-web-color2 border-[2px] border-web-color3 rounded-2xl`}
          >
            ...
            <div className="flex gap-[10px] items-center">
              <p className="text-sofiaCall-dark font-poppinsRegular text-[12px]">
                {user?.email}
              </p>
