        ...
        reader.onloadend = async function () {
          ...
          sortedOrganizations.forEach(org => {
            tableBody.push([
              ...
              { text: org.email || org.owner?.user.email || '-', style: 'tableCell' },
              { text: org.description || '-', style: 'tableCell' },
              { text: org.users?.toString() || '0', style: 'tableCell', alignment: 'right' },
              { text: org.departments !== undefined ? org.departments.toString() : '-', style: 'tableCell', alignment: 'right' }
            ]);
          });
