  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await handleOperation(
      ...
      },
      {
        ...
        successText: "Se ha guardado la información de WhatsApp",
        errorTitle: "Error al guardar",
        loadingTitle: "Guardando configuración de WhatsApp",
      }
    );
  ...
  const getIntegrationWhatsAppManualInfo = async () => {
    ...
    const result = await handleOperation(
      ...
      },
      {
        ...
        successText: "Se ha cargado la configuración de WhatsApp",
        errorTitle: "Error al cargar",
        loadingTitle: "Cargando configuración de WhatsApp",
        showSuccess: false,
      }
    );
